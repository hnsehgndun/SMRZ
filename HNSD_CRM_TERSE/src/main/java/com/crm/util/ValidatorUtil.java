...
public class ValidatorUtil {
     ...
     * 正则表达式：验证经度
     */
    public static final String LONGITUDE = "[\\-+]?(0?\\d{1,2}|0?\\d{1,2}\\.\\d{1,15}|1[0-7]?\\d|1[0-7]?\\d\\.\\d{1,15}|180|180\\.0{1,15})";
    ...
    public static boolean isLongitude(String longitude) {
        return Pattern.matches(LONGITUDE, longitude);
    }
    ...
    public static boolean isLatitude(String latitude) {
        return Pattern.matches(LATITUDE, latitude);
    }
